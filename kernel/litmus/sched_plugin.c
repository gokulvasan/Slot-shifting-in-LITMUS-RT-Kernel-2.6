...
/* This is not a good or generic name. We can later change it to something
 * better */
static long litmus_dummy_slot_shift_add_interval(
				struct res_data __user *res_type,
				void *inj)
{
	return -EINVAL;
}

static long litmus_dummy_slot_shift_aper_count(int res_id, unsigned int count) 
{
	return -EINVAL;	
}
...
struct sched_plugin linux_sched_plugin = {
	...
	.slot_shift_add_interval = litmus_dummy_slot_shift_add_interval,
	.slot_shift_aper_count = litmus_dummy_slot_shift_aper_count,
};
