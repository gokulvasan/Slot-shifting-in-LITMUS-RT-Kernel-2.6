...
__SYSCALL(__NR_set_task_table_data, sys_set_task_table_data)
#define __NR_set_aper_sched_timeout			__LSC(15)
__SYSCALL(__NR_set_aper_sched_timeout, set_aper_sched_timeout)
#define __NR_slot_shift_add_interval		__LSC(16)
__SYSCALL(__NR_slot_shift_add_interval, sys_slot_shift_add_interval)
#define __NR_sys_slot_shift_aper_cnt		__LSC(17)
__SYSCALL(__NR_sys_slot_shift_aper_cnt, sys_slot_shift_aper_cnt)
